// supabase/functions/notify-staff-removed/index.ts
//
// Called from the Team page after removing someone's staff access.
// Sends a brief, professional notice.
  ...
  try {
    ...
    const html = `
      <div style="font-family: sans-serif; max-width: 480px; margin: 0 auto; color: #0F1B33;">
        <h2 style="font-family: Georgia, serif;">Staff Access Update</h2>
        <p>Hi ${firstName},</p>
        <p>This is to inform you that your access to the True Doc Pros staff portal has been removed.</p>
        <p>If you have any questions, or would like to discuss regaining access, please reach out
    ...
    const emailRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: fromEmail,
        to: email,
        subject: 'Your True Doc Pros staff access has been removed',
        html,
      }),
    })
